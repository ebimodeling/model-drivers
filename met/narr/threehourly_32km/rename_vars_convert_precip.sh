...
ncrename -v apcp,precipitation_flux -v dswrf,surface_downwelling_shortwave_flux_in_air -v rhum,relative_humidity -v air,air_temperature -v vwnd,northward_wind -v uwnd,eastward_wind 2009.nc 2009_rename.nc
...
ncatted -a units,precipitation_flux,o,c,'kg m-2 s-1' 2009_rename.nc 2009_rename2.nc
